...
local ccClasses = {
  ...
  ["DRUID"] = {
    ...
    [CCTYPE_CYCLONE] = true,
    [CCTYPE_ROOTS] = true,
    [CCTYPE_INFWOUNDS] = true,
    [CCTYPE_GROWL] = true,
    [CCTYPE_MAIM] = true,
    [CCTYPE_BASH] = true,
    [CCTYPE_SLOW] = true,
    [CCTYPE_IMMOBILITY] = true,
    [CCTYPE_INTERRUPT] = true,
    [CCTYPE_PARALYSIS] = true,
  },
  ["HUNTER"] = {
    [CCTYPE_TRAP] = true,
    [CCTYPE_SCAREBEAST] = true,
    [CCTYPE_ROOTS] = true,
    [CCTYPE_SLEEP] = true,
    [CCTYPE_TAUNT] = true,
    [CCTYPE_SLOW] = true,
  ...
  ["PALADIN"] = {
    [CCTYPE_TURNEVIL] = true,
    [CCTYPE_REPENTANCE] = true,
    [CCTYPE_RD] = true,
    [CCTYPE_HOLYWRATH] = true,
    [CCTYPE_HOJ] = true,
    [CCTYPE_TAUNT] = true,
    [CCTYPE_INTERRUPT] = true,
  },
  ...
  ["WARLOCK"] = {
    ...
    [CCTYPE_FEAR] = true,
    [CCTYPE_TONGUES] = true,
    [CCTYPE_EXHAUSTION] = true,
    [CCTYPE_DEATHCOIL] = true,
    [CCTYPE_INTERRUPT] = true,
    [CCTYPE_COMA] = true,
  },
...
GhostRecon.ccList = {
  ...
  [CCTYPE_INTERRUPT] = {
    ...
    [202137] = true,
    [351338] = true,
  }, --断法禁法  C_Spell.GetSpellInfo(57944) Increased Damage 3
...
local function LocalizeCCTypeNames()
  for i, _ in pairs(GhostRecon.ccList) do
    for j, _ in pairs(GhostRecon.ccList[i]) do
      local spellInfo = C_Spell.GetSpellInfo(j)
    ...
    if showSpells then
      ...
      if mobInfo.spells then
        ...
        for _, i in pairs(spells) do
          local spellInfo = C_Spell.GetSpellInfo(i.spellId)
          local name, texture, castTime = spellInfo and spellInfo.name, spellInfo and spellInfo.iconID, spellInfo and (spellInfo.castTime or 0)
          local minRange, maxRange = spellInfo and (spellInfo.minRange or 0), spellInfo and (spellInfo.maxRange or 0)
          local right = ""
