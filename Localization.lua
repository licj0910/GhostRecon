...
if LOCALE == "enUS" then
  ...
  L["Received spell/ability information: %s has a spell/ability called %s (%s).  Sent by %s."] =
    "Received spell/ability information: %s has a spell/ability called %s (%s).  Sent by %s."
...
if LOCALE == "zhCN" then
  ...
  L["Received spell information: %s is removable.  Sent by %s."] = "收到法术信息: %s 可驱散.  来自 %s."
  ...
  L["Saw dispel: %s is removable."] = "发现驱散: %s 可驱散。"
...
if LOCALE == "zhTW" then
  ...
  L["Received spell information: %s is removable.  Sent by %s."] = "收到法術信息: %s 可驅散.  來自 %s."
  ...
  L["Saw dispel: %s is removable."] = "發現驅散: %s 可驅散。"
